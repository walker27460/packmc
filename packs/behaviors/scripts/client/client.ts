...
namespace Client {
	...
	system.initialize = function() {
		...
		system.registerEventData("example:pinky", eventDataDefaults)
	...
	system.update = function() {
		...
		if (firstTick) {
			...
			const eventData = system.createEventData("example:pinky");
			eventData.data.narf = true;

			system.broadcastEvent("example:pinky", eventData);
		}
	}
}